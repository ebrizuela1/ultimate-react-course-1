...
//   pages: 1210,
//   // spread of entire book object ...-> spread operator
//   ...book,
...
// // 3) Update book obj in arr
// const booksAfterUpdate = booksAfterDelete.map((book) =>
//   book.id === 1 ? { ...book, pages: 1 } : book
// );
// booksAfterUpdate;

// request fired off request to API then waits for it to be done with a promise and the second then recieves actual data
